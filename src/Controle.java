...
public class Controle // classe com métodos estáticos para realizar as operacoes de Imagem
{
    ...
    public static void soma(JanelaInterna j1, JanelaInterna j2)
    {
        ...
        float matrizBlue[][]=somaMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=somaMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=somaMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
    ...
    public static void subtrai(JanelaInterna j1, JanelaInterna j2)
    {
        ...
        float matrizBlue[][]=subtraiMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=subtraiMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=subtraiMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
    ...
    public static void or(JanelaInterna j1, JanelaInterna j2)
    {
        ...
        float matrizBlue[][]=orMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=orMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=orMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
    ...
    {        
        ...
        float matrizBlue[][]=norMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=norMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=norMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
    ...
    public static void and(JanelaInterna j1, JanelaInterna j2)
    {
        ...
        float matrizBlue[][]=andMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=andMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=andMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
    ...
    public static void nand(JanelaInterna j1, JanelaInterna j2){
        ...
        float matrizBlue[][]=nandMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=nandMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=nandMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
    ...
    public static void xor(JanelaInterna j1, JanelaInterna j2){
        ...
        float matrizBlue[][]=xorMatriz(j1.getBlue(), j2.getBlue(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizRed[][]=xorMatriz(j1.getRed(), j2.getRed(), j1.getLarguraImagem(), j1.getAlturaImagem());
        float matrizGreen[][]=xorMatriz(j1.getGreen(), j2.getGreen(), j1.getLarguraImagem(), j1.getAlturaImagem());
